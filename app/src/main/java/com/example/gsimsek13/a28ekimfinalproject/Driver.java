...
public class Driver extends User {
    ...
    public Driver(int id, int role, String name, String surname, String email, double phoneNumber, double rating, double latitude, double longitude, HashMap<String, DriverRoutes> routes) {
